...
The Master_6_trim that we created during the trimming step (in there is sync Mastertime, Neuro_frames, Cam_frames and DLC coords)
The Neuro_9_Cascade traces csv (in there is framewise the spikeprob, dfovernoise and zscore for each cell)
'''
