...
input_path = r"C:\Users\landgrafn\Desktop\a\RI_Example.mp4"
output_path = r"C:\Users\landgrafn\Desktop\a\RI_Example_fr.mp4"
...
for frame_nb in tqdm(range(total_frames), desc='Nb on frames'):
    ...
    cv2.putText(frame, f'{frame_nb}', (width-60,20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,0), 1, cv2.LINE_AA)
