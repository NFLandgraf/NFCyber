...
#left arm
left_corner = (195, 175)
middle_corner = (220, 130)
left_arm_end_lefter = (0, 55)
left_arm_end_righter = (25, 0)

#middle arm
right_corner = (240, 180)
middle_arm_end_righter = (230, 420)
middle_arm_end_lefter = (175, 420)

#right arm
right_arm_end_righter = (450, 75)
right_arm_end_lefter = (425, 30)
...
def do_stuff(file, create_video=False):
    ...
    def do_video(csv_file, all_positions):
        ...
        # create new video
        output_video_file = input_video_file.with_name(input_video_file.stem + '_YLineAreas' + '.mp4')
...
for csv_file in csv_files:
    ...
    do_stuff(csv_file, create_video=True)
